...
export const COMMON_FILTERS: FilterField[] = [
  ...
  { field: "salesManager", table: "case", label: "영업 담당자", type: "text" },
  { field: "caseManager", table: "case", label: "실무 담당자", type: "text" },
  { field: "salesRoute", table: "case", label: "영업 경로", type: "text" },
  { field: "isOneStop", table: "case", label: "원스톱", type: "boolean" },
  { field: "contractDate", table: "case", label: "약정일자", type: "date_range" },
  { field: "receptionDate", table: "case", label: "접수일자", type: "date_range" },
];
...
export const HEARING_LOSS_FILTERS: FilterField[] = [
  ...
  { field: "disposalReceivedAt", table: "hearingLoss", label: "처분수신일", type: "date_range" },
  { field: "specialClinic", table: "hearingLoss", label: "특진병원", type: "text" },
  { field: "firstClinic", table: "hearingLoss", label: "초진병원", type: "text" },
  { field: "expertOrg", table: "hearingLoss", label: "전문조사기관", type: "text" },
