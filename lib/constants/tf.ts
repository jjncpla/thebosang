export const TF_BY_BRANCH: Record<string, string[]> = {
  ...
  "노무법인 더보상 경남창원지사": ["더보상창원TF", "이산창원TF"],
  "노무법인 더보상 경북포항지사": ["더보상포항TF", "이산포항TF"],
  "노무법인 더보상 경북구미지사": ["더보상구미TF", "이산구미TF", "이산문경TF"],
  "노무법인 더보상 대구지사": ["더보상대구TF", "이산대구달서TF", "이산대구수성TF"],
  "노무법인 더보상 서울북부지사": ["더보상직업병상담소TF"],
  "노무법인 더보상 강원동해지사": ["더보상동해TF", "이산영동TF"],
  "노무법인 더보상 경기안산지사": ["더보상안산TF", "이산영서TF", "이산용인TF"],
  "노무법인 더보상 경기의정부지사": ["더보상의정부TF", "이산의정부TF", "이산성남TF"],
  "노무법인 더보상 대전지사": ["더보상대전TF", "이산청주TF", "이산충주TF"],
  "노무법인 더보상 경기수원지사": ["더보상수원TF", "이산수원TF", "이산평택TF"],
  "노무법인 더보상 경인지사": ["더보상경인TF", "이산인천TF", "이산인천북부TF"],
  "노무법인 더보상 서울구로지사": ["더보상구로TF", "이산부천TF"],
  "노무법인 더보상": ["이산제주TF", "이산마곡TF"],
  "노무법인 더보상 산재연구원": ["이산서울지역본부TF", "이산서울동부TF"],
  "노무법인 더보상 전북익산지사": ["더보상익산TF", "이산전북TF", "이산전주TF"],
