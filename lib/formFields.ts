export type FieldEntry = { key: string; label: string; x: number; y: number }
...
export const FORM_FIELDS: Record<string, FieldEntry[]> = {
  ...
  INFO_DISCLOSURE_PROXY: [
    ...
    { key: "claimantJumin1",    label: "청구인 주민번호 1",  x: 0,   y: 0   },
    { key: "claimantJumin2",    label: "청구인 주민번호 2",  x: 0,   y: 0   },
    { key: "claimantJumin3",    label: "청구인 주민번호 3",  x: 0,   y: 0   },
    { key: "claimantJumin4",    label: "청구인 주민번호 4",  x: 0,   y: 0   },
    { key: "claimantJumin5",    label: "청구인 주민번호 5",  x: 0,   y: 0   },
    { key: "claimantJumin6",    label: "청구인 주민번호 6",  x: 0,   y: 0   },
    { key: "claimantJumin7",    label: "청구인 주민번호 7",  x: 0,   y: 0   },
    { key: "claimantJumin8",    label: "청구인 주민번호 8",  x: 0,   y: 0   },
    { key: "claimantJumin9",    label: "청구인 주민번호 9",  x: 0,   y: 0   },
    { key: "claimantJumin10",   label: "청구인 주민번호 10", x: 0,   y: 0   },
    { key: "claimantJumin11",   label: "청구인 주민번호 11", x: 0,   y: 0   },
    { key: "claimantJumin12",   label: "청구인 주민번호 12", x: 0,   y: 0   },
    { key: "claimantJumin13",   label: "청구인 주민번호 13", x: 0,   y: 0   },
    { key: "agentJumin1",       label: "수임인 주민번호 1",  x: 0,   y: 0   },
    { key: "agentJumin2",       label: "수임인 주민번호 2",  x: 0,   y: 0   },
    { key: "agentJumin3",       label: "수임인 주민번호 3",  x: 0,   y: 0   },
    { key: "agentJumin4",       label: "수임인 주민번호 4",  x: 0,   y: 0   },
    { key: "agentJumin5",       label: "수임인 주민번호 5",  x: 0,   y: 0   },
    { key: "agentJumin6",       label: "수임인 주민번호 6",  x: 0,   y: 0   },
    { key: "agentJumin7",       label: "수임인 주민번호 7",  x: 0,   y: 0   },
    { key: "agentJumin8",       label: "수임인 주민번호 8",  x: 0,   y: 0   },
    { key: "agentJumin9",       label: "수임인 주민번호 9",  x: 0,   y: 0   },
    { key: "agentJumin10",      label: "수임인 주민번호 10", x: 0,   y: 0   },
    { key: "agentJumin11",      label: "수임인 주민번호 11", x: 0,   y: 0   },
    { key: "agentJumin12",      label: "수임인 주민번호 12", x: 0,   y: 0   },
    { key: "agentJumin13",      label: "수임인 주민번호 13", x: 0,   y: 0   },
