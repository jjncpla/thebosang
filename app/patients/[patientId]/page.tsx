  ...
  return (
    <div>
      ...
      {caseItem.caseType === "HEARING_LOSS" && (
        <div style={{ background: "white", borderRadius: 10, border: "1px solid #e5e7eb", padding: 20, marginBottom: 16, boxShadow: "0 1px 3px rgba(0,0,0,0.05)" }}>
          <div style={{ fontSize: 11, fontWeight: 700, color: "#6b7280", letterSpacing: 1, marginBottom: 16 }}>난청 상세</div>
