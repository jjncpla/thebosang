...
const FORM_FIELDS: Record<string, { key: string; label: string; x: number; y: number }[]> = {
  DISABILITY_CLAIM: [
    ...
    { key: "bankChangeYes",    label: "수령계좌변경 예",      x: 0, y: 0 },
    { key: "bankChangeNo",     label: "수령계좌변경 아니오",  x: 0, y: 0 },
    { key: "bankName",         label: "은행명",               x: 0, y: 0 },
    { key: "bankAccount",      label: "계좌번호",             x: 0, y: 0 },
    { key: "bankHolder",       label: "예금주",               x: 0, y: 0 },
    { key: "bankTypeNormal",   label: "보통계좌 체크",        x: 0, y: 0 },
    { key: "bankTypeSpecial",  label: "전용계좌 체크",        x: 0, y: 0 },
    { key: "confirm1Yes",      label: "확인①예",              x: 0, y: 0 },
    { key: "confirm1No",       label: "확인①아니오",          x: 0, y: 0 },
    { key: "confirm2Yes",      label: "확인②예",              x: 0, y: 0 },
    { key: "confirm2No",       label: "확인②아니오",          x: 0, y: 0 },
    { key: "receiptDate",      label: "수령일자",             x: 0, y: 0 },
    { key: "receiptAmount",    label: "수령금액",             x: 0, y: 0 },
    { key: "receiptPayer",     label: "지급한자",             x: 0, y: 0 },
    { key: "transferCost",     label: "이송비용",             x: 0, y: 0 },
    { key: "transferDetail",   label: "이송비산출내역",       x: 0, y: 0 },
    { key: "compPart",         label: "합병증부위",           x: 0, y: 0 },
    { key: "compHospital",     label: "합병증의료기관",       x: 0, y: 0 },
  ],
  NOISE_WORK_CONFIRM: [
